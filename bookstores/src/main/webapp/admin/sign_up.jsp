      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            <div align="center">
             	<c:if test="${user == null}">
              		<h4>Bắt đầu trên EBookStore ngay hôm nay</h4>
              	</c:if>
              	<c:if test="${user != null}">
              ...
              <div class="card-body">
                ...
                <c:if test="${user != null}">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-warning">Gửi</button>&nbsp;&nbsp;
                    <button type="submit" id="buttonCancel" class="btn bg-gradient-warning">Hủy</button>
                  </div>
