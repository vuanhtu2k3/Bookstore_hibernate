...
<title>Quản lý đánh giá - EBookStore</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="#">Quản lý đánh giá</a></h5>   
              </div>
            </div> <br>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Xếp hạng</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Cảm nhận</th>
                    ...
                    <tr>
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<p class="text-xs font-weight-bold mb-0">${review.review_id }</p>
                        </div>
                      </td>    
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<p class="text-xs font-weight-bold mb-0">${review.book.name }</p>
                        </div>
                      </td>
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                      ...
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                      		<p class="text-xs font-weight-bold mb-0">${review.comment }</p>  
                      	</div>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="edit_review?id=${review.review_id}" class="text-secondary font-weight-bold text-xs">
                        ...
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs">
                          <i class="fa fa-trash-o deleteLink" id="${review.review_id}" aria-hidden="true" style="color: red;">&nbsp;Xóa</i>
                        </a>
                      </td>
                    </tr>
