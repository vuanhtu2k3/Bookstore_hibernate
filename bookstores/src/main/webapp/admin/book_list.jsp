...
<br>
	...
	<div class="row">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="new_book">Thêm sách mới</a></h5>   
              </div>
            </div> <br>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Thể loại</th>
       ...
       <div class="d-flex flex-column justify-content-center">
               <img src="images/${book.image}" style="width: 60px; height: 60px" >
            </div>
                      ...
                      <td class="align-middle">
                       <a href="new_book" class="text-secondary font-weight-bold text-xs">
                        ...
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs">
                          <i class="fa fa-trash-o deleteLink" id="${book.bookId}" aria-hidden="true" style="color: red;">&nbsp;Xóa</i>
                        </a>
                      </td>
                    </tr>
