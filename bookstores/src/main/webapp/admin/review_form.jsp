          ...
          <div class="row">
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <h4 class="font-weight-bolder">Cập nhật đánh giá</h4>               
                </div>
                ...
                <form action="update_review" method="post" id="reviewForm">
					<input type="hidden" name="reviewId" value="${review.review_id}">
                      ...
                      <input type="text" value="${review.book.name}" class="form-control" readonly="readonly"/>
                    </div>
                     <label>Xếp hàng:</label>
                    <div class="input-group input-group-outline mb-3">  
...
$(document).ready(function() {
	$("#reviewForm").validate({
		...
		messages: {
			headline: "Vui lòng nhập tiêu đề",
