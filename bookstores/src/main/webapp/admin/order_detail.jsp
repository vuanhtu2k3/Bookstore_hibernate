...
<title>Chi tiết đơn hàng - EBookStore</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="#">Chi tiết đơn hàng</a></h5>   
              </div>
            </div> <br>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tổng cộng</th>
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<p class="text-xs font-weight-bold mb-0">${orderDetail.book.name}</p>
                        </div>
                      </td>   
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
                        		<p class="text-xs font-weight-bold mb-0"><img src="images/${orderDetail.book.image}" style="width: 60px; height: 60px;"></p>
                        </div>
                      </td> 
                      <td>
                      	<div class="d-flex flex-column justify-content-center">
