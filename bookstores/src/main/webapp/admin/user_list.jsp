          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="sign_up.jsp">Thêm người dùng</a></h5>   
              </div>
            </div> <br>
                      ...
                      <td class="align-middle">
                       <a href="sign_up.jsp" class="text-secondary font-weight-bold text-xs">
                        ...
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs">
                          <i class="fa fa-trash-o deleteLink" id="${user.userId}" aria-hidden="true" style="color: red;">&nbsp;Xóa</i>
                        </a>
                      </td>
                    </tr>
		...
		$(document).ready(function() {
			$(".deleteLink").each(function() {
				$(this).on("click", function() {
					userId = $(this).attr("id");
					if (confirm('Bạn có chắc chắn xóa người dùng với ID  ' +  userId + '?')) {
