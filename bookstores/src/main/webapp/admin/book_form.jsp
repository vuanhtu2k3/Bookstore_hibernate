...
<title>Quản lý sách - EBookStore</title>
          ...
          <div class="row">
              <div class="card card-plain">
                <div class="card-header text-center">
                	<c:if test="${book != null }">
                  		<h4 class="font-weight-bolder">Cập nhật sách </h4>
                   </c:if>
                   <c:if test="${book == null }">
                  		<h4 class="font-weight-bolder">Thêm sách</h4>
                   </c:if>
                </div>
                 <br>
                ...
                <div class="card-body">
                   ...
                   <c:if test="${book == null }">
                    <form action="create_book" method="post" role="form" id="bookForm" enctype="multipart/form-data">
                      ...
                      <input type="text" id="name" name="name" class="form-control" size="20" placeholder="Name" value="${book.name }">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="input-group input-group-outline mb-3">
                     ...
                     <div class="mb-3"> 
                      ...
                      <label for="formFile" class="form-label">File Image(*)</label>
 						<input type="file" id="bookImage" name="bookImage" size="20" /><img class="form-control" id="bookImage" name="bookImage" alt="Image Preview" style="width:20%; margin-top: 10px"
						 src="images/${book.image}"style="width: 60px; height: 60px">
