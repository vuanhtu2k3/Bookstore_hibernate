...
<title>Quản lý khách hàng - EBookStore</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3 text-center">
                <h5><a class="text-white text-capitalize ps-3" href="new_customer">Thêm người dùng</a></h5>   
              </div>
            </div> <br>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mã ID</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Email</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên đầy đủ</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                       ...
                       <td>
                      	<div class="d-flex flex-column justify-content-center">
                        	<p class="text-xs font-weight-bold mb-0">${customer.addressLine1}</p>
                        </div>
                      </td> 
                      ...
                      <td class="align-middle">    
                       <a href="new_customer" class="text-secondary font-weight-bold text-xs">
                        ...
                        <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs">
                          <i class="fa fa-trash-o deleteLink" id="${customer.customerId}" aria-hidden="true" style="color: red;">&nbsp;Xóa</i>
                        </a>
                      </td>
                    </tr>
