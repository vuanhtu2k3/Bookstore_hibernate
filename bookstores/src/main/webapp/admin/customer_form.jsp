              ...
              <div class="card card-plain">
                <div class="card-header text-center">
                	<c:if test="${customer != null }">
                  		<h4 class="font-weight-bolder">Cập nhật khách hàng</h4>
                   </c:if>
                   <c:if test="${customer == null }">
                  		<h4 class="font-weight-bolder">Tạo khách hàng mới</h4>
                   </c:if>
                </div>
                 <br>
                ...
                <div class="card-body">
                   ...
                   <c:if test="${customer == null }">
                    ...
                    <div class="input-group input-group-outline mb-3">                      
                      <input type="text"  placeholder="FullName" id="fullname" name="fullname" size="45" value="${customer.fullname}" class="form-control">
                    </div>
                   ...
                   <br>
                    <div class="text-center">
                      ...
                      <button type="button" class="btn btn-lg bg-gradient-warning" id="buttonCancel">Hủy</button>
                    </div>
                  </form>
                </div>     
              </div>
