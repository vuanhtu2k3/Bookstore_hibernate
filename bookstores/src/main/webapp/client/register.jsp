...
<div class="container login-container">
    <div class="col-lg-6 col-md-6 login-part-form">
        <div class="login_part_form_iner">
            ...
            <form class="row contact_form" id="loginForm" action="register_customer" method="post">
                <h3 class="text-center mb-4 login-heading">
                    Đăng ký
                </h3>
                  <div class="col-md-12 form-group p_star">
                    <input type="text" class="form-control" id="fullname" name="fullname" size="45" placeholder="Tên đầy đủ" required>
                </div>
                <div class="col-md-12 form-group p_star">
                ...
                <div class="col-md-12 form-group p_star">
                    <input type="text" class="form-control" id="phone" name="phone" size="45" placeholder="Số điện thoại" required>
                </div>
                <div class="col-md-12 form-group p_star">
                    <input type="text" class="form-control" id="addressline1" name="addressline1" size="45" placeholder="Địa chỉ" required>
                </div>
