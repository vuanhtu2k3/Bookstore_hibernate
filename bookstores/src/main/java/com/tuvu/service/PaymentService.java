...
public class PaymentService {
	...
	private List<Transaction> getTransactionInformation(BookOrder order) {
		...
		transaction.setDescription("EStoreOnline");
		...
		while (iterator.hasNext()) {
			...
			Item item = new Item();
			item.setCurrency("VND").setName(book.getName()).setQuantity(String.valueOf(quantity))
	...
	private ShippingAddress getShippingInformation(BookOrder order) {
		...
		String recipientName = order.getFullname() + " " ;
