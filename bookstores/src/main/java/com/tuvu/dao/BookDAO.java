...
public class BookDAO extends JpaDAO<Book> implements GenericDAO<Book> {
	...
	public Book findByName(String name) {
		List<Book> result = super.findWithNamedQuery("Book.findByName", "name", name);
	...
	public List<Book> listMostFavoredBooks() {
		...
		List<Object[]> result = super.findWithNamedQueryObjects("Review.mostFavoredBooks", 0, 3);
